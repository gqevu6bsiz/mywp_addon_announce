...
final class MywpSettingScreenAnnounce extends MywpAbstractSettingModule {

  static protected $id = 'announce';

  static protected $priority = 50;

  static private $menu = 'add_on_announce';

  static private $post_type = 'mywp_announce';
  ...
  public static function ajax_add_item() {
    ...
    do_action( 'mywp_setting_announce_ajax_add_item' , $post_id , $add_item );
...
<?php
  ...
  private static function get_current_setting_announce_items() {
    ...
    self::$current_setting_announce_items = apply_filters( 'mywp_setting_announce_get_current_setting_announce_items' , $current_setting_announce_items );
    ...
    <div class="item-content item-type-<?php echo esc_attr( $item_type ); ?>">
      ...
      <div class="item-content-fields">
        ...
        <div class="item-content-hidden-fields">
          ...
          <?php self::print_item_content_field( 'item_hide_sites' , '' , $item ); ?>
