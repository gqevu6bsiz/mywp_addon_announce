...
if ( ! class_exists( 'MywpPostTypeModuleAnnounce' ) ) :

final class MywpPostTypeModuleAnnounce extends MywpPostTypeAbstractModule {

  protected static $id = 'mywp_announce';

  protected static function get_regist_post_type_args() {

    $args = array(
      'label' => 'My WP Announce',
...
MywpPostTypeModuleAnnounce::init();
